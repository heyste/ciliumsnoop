...
{#if release}
  <SectionHeader title={""}>
    <h2>{release} Cilium Testing Coverage
    ...
    <p>
      We are interested if this project can be extended to help Cilium conformance. Our current questions are:
    </p>
    <ul>
      <li>How does Cilium currently measure coverage progress?  If one were to say "Cilim is 100% covered by conformance tests", how would
        that be shown or verified?</li>
      <li>Where does the Cilium spec live? Does it consist of Kubernetes CRD's only? If not, what else is included in the spec?</li>
      <li>Is there a recommended method and target for running the Cilium suite currently?</li>
